...
Growing up in Kenya using M-Pesa, this isn't just a dataset, it's a lived experience. Today, Kenya stands as the premier global reference case for fintech innovation and financial inclusion. In 2024 alone, mobile money network scaled to orchestrate transaction volumes equivalent to over half of the nation's entire GDP. 
This project transitions into a data driven narrative by building an automated pipeline that ingests, cleans, tests and models public financial data into interactive, geospatial insights.
